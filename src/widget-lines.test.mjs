...
const long = widgetLines(
  [{ id: "crmback-1a2", repo: "crm-backend", title: "x".repeat(200) }],
  40,
);
...
const cjk = widgetLines(
  [{ id: "p-1", repo: "r", title: "\u6f22".repeat(60) }],
  30,
);
...
const emo = widgetLines(
  [{ id: "p-1", repo: "r", title: "\u{1F600}".repeat(60) }],
  30,
);
